const FormAutoFill = new Vue({
  ...
  data: {
    ...
    gas: 'https://script.google.com/macros/s/1-SujpzpNewtAqowdHnICpd6uyfdRJIf3f7GAxlaHEbA/exec',
    ...
    formAction: 'https://docs.google.com/forms/u/0/d/e/1FAIpQLSdzpELlY9_8LlBL63krQSz4rvW92otiJOb3so3DW7dvNQiUz/formResponse',
    
    // Google Form 各個 input 的 name
    input: {
      id: 'entry.1214180640',
      name: 'entry.983416634',
      gender: 'entry.234035385',
      phone: 'entry.1223898217',
      site: 'entry.694005764',
      msg: 'entry.1235097295'
    },
